...
pip3 -q install --user --upgrade setuptools wheel mako meson==0.56.2 pyelftools lit==12.0.0 pyparsing==2.4.7 pydot git+https://github.com/revng/grandiso-networkx.git
